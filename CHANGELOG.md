...
- **Dark mode** — added missing `dark:` classes to AI Optimization (page + targeting fields) and the OnPage tools hub, which stayed light-themed while the rest of the dashboard was dark-aware.
